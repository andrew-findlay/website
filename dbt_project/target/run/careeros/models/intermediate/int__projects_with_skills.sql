  ...
  create view "careeros"."main_intermediate"."int__projects_with_skills__dbt_tmp" as (
    with projects as (
    select * from "careeros"."main_staging"."stg__projects"
),

project_skill as (
    select * from "careeros"."main_raw"."project_skill"
),
