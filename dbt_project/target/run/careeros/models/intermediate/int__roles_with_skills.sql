  ...
  create view "careeros"."main_intermediate"."int__roles_with_skills__dbt_tmp" as (
    with roles as (
    select * from "careeros"."main_intermediate"."int__roles_with_achievements"
),

role_skills as (
    select * from "careeros"."main_staging"."stg__role_skills"
)
