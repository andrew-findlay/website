  ...
  create view "careeros"."main_staging"."stg__profile__dbt_tmp" as (
    with person as (
    select * from "careeros"."main_raw"."person"
),

contact as (
    select * from "careeros"."main_raw"."contact_method"
),

social as (
    select * from "careeros"."main_raw"."social_profile"
)
